"use strict";const St=require("react"),r=require("styled-components");var Q={exports:{}},A={};/**
 * @license React
...
Check the top-level render call using <`+a+">.")}return e}}function ht(t,e){{if(!t._store||t._store.validated||t.key!=null)return;t._store.validated=!0;var a=ar(e);if(xt[a])return;xt[a]=!0;var n="";t&&t._owner&&t._owner!==K.current&&(n=" It was passed a child from "+k(t._owner.type)+"."),C(t),u('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.',a,n),C(null)}}function Rt(t,e){{if(typeof t!="object")return;if(q(t))for(var a=0;a<t.length;a++){var n=t[a];H(n)&&ht(n,e)}else if(H(t))t._store&&(t._store.validated=!0);else if(t){var i=Yt(t);if(typeof i=="function"&&i!==t.entries)for(var f=i.call(t),s;!(s=f.next()).done;)H(s.value)&&ht(s.value,e)}}}function nr(t){{var e=t.type;if(e==null||typeof e=="string")return;var a;if(typeof e=="function")a=e.propTypes;else if(typeof e=="object"&&(e.$$typeof===d||e.$$typeof===b))a=e.propTypes;else return;if(a){var n=k(e);Mt(a,t.props,"prop",n,t)}else if(e.PropTypes!==void 0&&!G){G=!0;var i=k(e);u("Component %s declared `PropTypes` instead of `propTypes`. Did you misspell the property assignment?",i||"Unknown")}typeof e.getDefaultProps=="function"&&!e.getDefaultProps.isReactClassApproved&&u("getDefaultProps is only used on classic React.createClass definitions. Use a static property named `defaultProps` instead.")}}function or(t){{for(var e=Object.keys(t.props),a=0;a<e.length;a++){var n=e[a];if(n!=="children"&&n!=="key"){C(t),u("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.",n),C(null);break}}t.ref!==null&&(C(t),u("Invalid attribute `ref` supplied to `React.Fragment`."),C(null))}}var Ot={};function _t(t,e,a,n,i,f){{var s=At(t);if(!s){var o="";(t===void 0||typeof t=="object"&&t!==null&&Object.keys(t).length===0)&&(o+=" You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.");var y=er();y?o+=y:o+=kt();var l;t===null?l="null":q(t)?l="array":t!==void 0&&t.$$typeof===O?(l="<"+(k(t.type)||"Unknown")+" />",o=" Did you accidentally export a JSX literal instead of a component?"):l=typeof t,u("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s",l,o)}var m=rr(t,e,a,i,f);if(m==null)return m;if(s){var v=e.children;if(v!==void 0)if(n)if(q(v)){for(var P=0;P<v.length;P++)Rt(v[P],t);Object.freeze&&Object.freeze(v)}else u("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");else Rt(v,t)}if(X.call(e,"key")){var T=k(t),g=Object.keys(e).filter(function(mr){return mr!=="key"}),Z=g.length>0?"{key: someKey, "+g.join(": ..., ")+": ...}":"{key: someKey}";if(!Ot[T+Z]){var lr=g.length>0?"{"+g.join(": ..., ")+": ...}":"{}";u(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`,Z,T,lr,T),Ot[T+Z]=!0}}return t===h?or(m):nr(m),m}}function sr(t,e,a){return _t(t,e,a,!0)}function ir(t,e,a){return _t(t,e,a,!1)}var fr=ir,cr=sr;F.Fragment=h,F.jsx=fr,F.jsxs=cr}()),F}process.env.NODE_ENV==="production"?Q.exports=dr():Q.exports=ur();var Tt=Q.exports;const pr=r.keyframes`
  from,
  20%,
  53%,
  to {
...
`,na=Object.freeze(Object.defineProperty({__proto__:null,backInDown:Tr,backInLeft:Sr,backInRight:Ir,backInUp:Yr,backOutDown:Cr,backOutLeft:Pr,backOutRight:jr,backOutUp:Dr,bounce:pr,bounceIn:Xr,bounceInDown:Lr,bounceInLeft:Ar,bounceInRight:Fr,bounceInUp:zr,bounceOut:$r,bounceOutDown:Ur,bounceOutLeft:Wr,bounceOutRight:Br,bounceOutUp:Mr,fadeIn:Vr,fadeInBottomLeft:Nr,fadeInBottomRight:qr,fadeInDown:Jr,fadeInDownBig:Kr,fadeInLeft:Gr,fadeInLeftBig:Hr,fadeInRight:Zr,fadeInRightBig:Qr,fadeInTopLeft:te,fadeInTopRight:re,fadeInUp:ee,fadeInUpBig:ae,fadeOut:ne,fadeOutBottomLeft:oe,fadeOutBottomRight:se,fadeOutDown:ie,fadeOutDownBig:fe,fadeOutLeft:ce,fadeOutLeftBig:le,fadeOutRight:me,fadeOutRightBig:de,fadeOutTopLeft:ue,fadeOutTopRight:pe,fadeOutUp:ye,fadeOutUpBig:ge,flash:yr,flip:ve,flipInX:be,flipInY:ke,flipOutX:xe,flipOutY:he,headShake:gr,heartBeat:vr,hinge:Ne,jackInTheBox:qe,jello:br,lightSpeedInLeft:Re,lightSpeedInRight:Oe,lightSpeedOutLeft:_e,lightSpeedOutRight:Ee,pulse:kr,rollIn:Me,rollOut:Ve,rotateIn:we,rotateInDownLeft:Te,rotateInDownRight:Se,rotateInUpLeft:Ie,rotateInUpRight:Ye,rotateOut:Ce,rotateOutDownLeft:Pe,rotateOutDownRight:je,rotateOutUpLeft:De,rotateOutUpRight:Xe,rubberBand:xr,shake:hr,shakeX:Rr,shakeY:Or,slideInDown:Le,slideInLeft:Ae,slideInRight:Fe,slideInUp:ze,slideOutDown:$e,slideOutLeft:Ue,slideOutRight:We,slideOutUp:Be,swing:_r,tada:Er,wobble:wr,zoomIn:Je,zoomInDown:Ke,zoomInLeft:Ge,zoomInRight:He,zoomInUp:Ze,zoomOut:Qe,zoomOutDown:ta,zoomOutLeft:ra,zoomOutRight:ea,zoomOutUp:aa},Symbol.toStringTag,{value:"Module"})),oa=c=>r.css`
